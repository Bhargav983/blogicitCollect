...
//        myInterval =  setInterval(checkBluetoothStatus, 5000);
//     //  alert('Home Screen was focused');0
//     console.log(bleOpend)
//     if(bleOpend===true)
//         alert('Active now')
//       return () => {
...
<TouchableOpacity style={styles.Bluebtn} 
  onPress={async () => {
    ...
    try{
      ...
      console.log("In Print1, read save =",readSave)
    ...
    console.log("In Print1, final  =",data_filter1[len-1])
...
>
   <Text style={styles.BluebtnText}>Print1 Reciept</Text>
  </TouchableOpacity> 
